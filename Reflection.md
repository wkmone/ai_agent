## [4.4 Reflection](https://datawhalechina.github.io/hello-agents/#/./chapter4/第四章 智能体经典范式构建?id=_44-reflection)
...
### [4.4.1 Reflection 机制的核心思想](https://datawhalechina.github.io/hello-agents/#/./chapter4/第四章 智能体经典范式构建?id=_441-reflection-机制的核心思想)
...
如图4.3所示，这个循环可以重复进行多次，直到反思阶段不再发现新的问题，或者达到预设的迭代次数上限。我们可以将这个迭代优化的过程形式化地表达出来。假设 Oi*O**i* 是第 i*i* 次迭代产生的输出（O0*O*0 为初始输出），反思模型 πreflect*π*reflect 会生成针对 Oi*O**i* 的反馈 Fi*F**i*：Fi=πreflect(Task,Oi)*F**i*=*π*reflect(Task,*O**i*)随后，优化模型 πrefine*π*refine 会结合原始任务、上一版输出以及反馈，生成新一版的输出 Oi+1*O**i*+1：Oi+1=πrefine(Task,Oi,Fi)*O**i*+1=*π*refine(Task,*O**i*,*F**i*)
...
### [4.4.2 案例设定与记忆模块设计](https://datawhalechina.github.io/hello-agents/#/./chapter4/第四章 智能体经典范式构建?id=_442-案例设定与记忆模块设计)
...
### [4.4.3 Reflection 智能体的编码实现](https://datawhalechina.github.io/hello-agents/#/./chapter4/第四章 智能体经典范式构建?id=_443-reflection-智能体的编码实现)
...
### [4.4.4 运行实例与分析](https://datawhalechina.github.io/hello-agents/#/./chapter4/第四章 智能体经典范式构建?id=_444-运行实例与分析)
...
### [4.4.5 Reflection 机制的成本收益分析](https://datawhalechina.github.io/hello-agents/#/./chapter4/第四章 智能体经典范式构建?id=_445-reflection-机制的成本收益分析)
