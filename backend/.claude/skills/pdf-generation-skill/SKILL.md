...
```
Bash(command="python3 .claude/skills/pdf-generation-skill/scripts/generate_pdf.py 'output.pdf' 'Content to put in PDF'")
```
...
**Agent:** [Uses Bash: python3 .claude/skills/pdf-generation-skill/scripts/generate_pdf.py hello.pdf 'Hello World']
